...
class ConsumerRetryableExceptionIT extends AbstractKafkaIT {
    ...
    @Test
    void testRepublishToRegistersDeltaErrorTopicThroughRetryTopics() throws Exception {
        // given
        ...
        assertThat(KafkaUtils.noOfRecordsForTopic(consumerRecords, KafkaUtils.RETRY_TOPIC)).isEqualTo(4);
        assertThat(KafkaUtils.noOfRecordsForTopic(consumerRecords, KafkaUtils.ERROR_TOPIC)).isOne();
